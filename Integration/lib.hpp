...
*/
#define STACK_LIMIT 32   // верхняя граница на количество записей в стеке
#define TRANSMIT_SIZE 20 // столько записей переносим за раз из локального стека в глобальный
